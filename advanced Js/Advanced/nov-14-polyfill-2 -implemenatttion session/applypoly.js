...
Function.prototype.apply2 = function(contextObj2 = {}, args){
//   console.log(this);
//   console.log(contextObj2);
  ...
  if(!Array.isArray(args)){
    throw new TypeError('provide argument is an array')
  }
...
console.log(printingVersion.apply2(objprasanna ,`delhi`,`india`));
